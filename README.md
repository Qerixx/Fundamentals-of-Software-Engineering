...
исправьте их.
Практическая 5:
А1)Напишите программу, которая укорачивает входной текст, удалив из текста все, что написано в
...
А2)Дан текст, состоящий из предложений. Предложения текста заканчиваются символами точка,
...
А3)Исходный текст состоит из слов, разделенных пробелом. Требуется получить строку, которая
...
А4)Генетический поиск - Формат выходного файла и пример:
